var areaid = "area";
var zipid = "zip";
var zip_codeid = "zip_code";
var ary2 = new Array(["100", "103", "104", "105", "106", "108", "110", "111", "112", "114", "115", "116"],
	...
	["411", "412", "413", "414", "420", "421", "422", "423", "424", "426", "427", "428", "429", "432", "433", "434", "435", "436", "437", "438", "439"],
	...
	["710", "711", "712", "713", "714", "715", "716", "717", "718", "719", "720", "721", "722", "723", "724", "725", "726", "727", "730", "731", "732", "733", "734", "735", "736", "737", "741", "742", "743", "744", "745"],
	["800", "801", "802", "803", "804", "805", "806", "807", "811", "812", "813", "814", "815", "817", "819", "820", "821", "822", "823", "824", "825", "826", "827", "828", "829", "830", "831", "832", "833", "840", "842", "843", "844", "845", "846", "847", "848", "849", "849", "851", "852"],
...
var ary = new Array(["中正區", "大同區", "中山區", "松山區", "大安區", "萬華區", "信義區", "士林區", "北投區", "內湖區", "南港區", "文山區"],
	...
	["太平市", "大里市", "霧峰鄉", "烏日鄉", "豐原市", "后里鄉", "石岡鄉", "東勢鎮", "和平鄉", "新社鄉", "潭子鄉", "大雅鄉", "神岡鄉", "大肚鄉", "沙鹿鎮", "龍井鄉", "梧棲鎮", "清水鎮", "大甲鎮", "外埔鄉", "大安鄉"],
	...
	["永康市", " 歸仁鄉", "新化鎮", "左鎮鄉", "玉井鄉", "楠西鄉", "南化鄉", "仁德鄉", "關廟鄉", "龍崎鄉", "官田鄉", "麻豆鎮", "佳里鎮", "西港鄉", "七股鄉", "將軍鄉", "學甲鎮", "北門鄉", "新營市", "後壁鄉", "白河鎮", "東山鄉", "六甲鄉", "下營鄉", "柳營鄉", "鹽水鎮", "善化鎮", "大內鄉", "山上鄉", "新市鄉", "安定鄉"],
	["新興區", "前金區", "苓雅區", "鹽埕區", "鼓山區", "旗津區", "前鎮區", "三民區", "楠梓區", "小港區", "左營區", "仁武區", "大社區", "東沙群島", "南沙群島", "岡山區", "路竹區", "阿蓮區", "田寮區", "燕巢區", "橋頭區", "梓官區", "彌陀區", "永安區", "湖內區", "鳳山區", "大寮區", "林園區", "鳥松區", "大樹區", "旗山區", "美濃區", "六龜區", "內門區", "杉林區", "甲仙區", "桃源區", "那瑪夏區", "三民區", "茂林區", "茄萣區"],
	["仁武鄉", "大社鄉", "岡山鎮", "路竹鄉", "阿蓮鄉", "田寮鄉", "燕巢鄉", "橋頭鄉", "梓官鄉", "彌陀鄉", "永安鄉", "湖內鄉", "鳳山市", "大寮鄉", "林園鄉", "鳥松鄉", "大樹鄉", "旗山鎮", "美濃鎮", "六龜鄉", "內門鄉", "杉林鄉", "甲仙鄉", "桃源鄉", "三民鄉", "茂林鄉", "茄萣鄉"],
...
function changeSel(value) {
    ...
    if (tmp.length > 0) {
        document.getElementById(zipid).options.length = tmp.length;
        for (var ii = 0; ii < tmp.length; ii++) {
            document.getElementById(zipid).options[ii] = new Option(tmp[ii], tmp[ii]);
        }
        changeCode();
    }
}
...
function changeCode() {
    if (document.getElementById(zip_codeid) == null || document.getElementById(zip_codeid) == undefined) return;
    var tmp = new Array();
    switch (document.getElementById(areaid).options[document.getElementById(areaid).selectedIndex].value) {
        case "台北市":
            tmp = ary2[0];
            break;
        case "基隆市":
    ...
    document.getElementById(zip_codeid).value = tmp[document.getElementById(zipid).selectedIndex];
}


var _area = {
    area: ["台北市", "新北市", "基隆市", "桃園市", "新竹縣", "新竹市", "台中市", "宜蘭縣", "苗栗縣", "高雄市", "彰化縣", "南投縣", "嘉義市", "嘉義縣", "雲林縣", "台南市", "澎湖縣", "屏東縣", "台東縣", "花蓮縣", "金門縣", "連江縣", "釣魚台"],
